    ...
    return (
        <div className={`${RegLogStyle.center} flex-col`}>
            <div className={`${RegLogStyle.center} flex-col`}>
                ...
                <h1 className="font-[600] text-[20px] mt-10 text-primary">
                    Tạo tài khoản mới
                </h1>
            </div>

            <div
                className={`flex justify-between flex-col gap-[25px] mt-10 w-[500px] rounded-[10px] shadow-[5px_5px_10px_rgba(0,0,0,0.3)] p-[37px] 
                bg-primary`}
            >
                <LoginForm />
